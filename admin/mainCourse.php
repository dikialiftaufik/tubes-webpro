...
function isColorDark(hex) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    let menuData = [
        {
            id: 1,
            image: "../img/main-course/sate-ayam.jpg",
            name: "Sate Ayam",
            price: 30000,
            calories: 360,
            ingredients: [
            ...
            description: "Lezatnya potongan daging ayam yang empuk dipadu dengan bumbu kacang gurih manis.",
        },
        {
            id: 2,
            image: "../img/main-course/tongseng-ayam.jpg",
            name: "Tongseng Ayam",
            price: 30000,
            calories: 350,
            ingredients: [
            ...
            description: "Kuah santan yang creamy dengan potongan ayam empuk, diperkaya bumbu rempah tradisional yang memanjakan lidah. ",
        },
        {
            id: 3,
            image: "../img/main-course/sate-sapi.jpg",
            name: "Sate Sapi",
            price: 30000,
            calories: 400,
            ingredients: [
            ...
            description: "Daging sapi yang juicy dan penuh cita rasa, dilumuri bumbu kecap manis atau kacang, lalu dipanggang hingga harum.",
        },
        {
            id: 4,
            image: "../img/main-course/tongseng-sapi.jpg",
            name: "Tongseng Sapi",
            price: 30000,
            calories: 400,
            ingredients: [
            ...
            description: "Hidangan klasik dengan potongan daging sapi yang lembut dalam kuah rempah yang kaya rasa. ",
        },
        {
            id: 5,
            image: "../img/main-course/sate-kambing.jpg",
            name: "Sate Kambing",
            price: 30000,
            calories: 420,
            ingredients: [
            { value: "Daging kambing" },
            { value: "bumbu kacang" },
            { value: "kecap" },
            { value: "lada bubuk" },
        ],
            description: "Daging kambing pilihan dengan tekstur lembut dan rasa khas, dipanggang sempurna lalu disajikan dengan kecap manis pedas. ",
        },
        {
            id: 6,
            image: "../img/main-course/tongseng-kambing.jpg",
            ...
            description: "Kenikmatan kuah santan dengan cita rasa gurih pedas, berpadu dengan daging kambing yang empuk. ",
        },
        {
            id: 7,
            image: "../img/main-course/nasi-goreng.jpg",
            ...
            description: "Nasi goreng ayam yang tak pernah mengecewakan! Perpaduan nasi hangat, potongan ayam juicy, dan bumbu rempah yang kaya akan cita rasa.",
        },{
            id: 7,
            image: "../img/main-course/tongseng-kering-sapi.jpg",
            name: "Tongseng Kering Sapi",
            price: 30000,
            calories: 570,
            ingredients: [
            { value: "Daging sapi" },
            ...
            description: "Daging sapi yang empuk dimasak dengan bumbu khas yang kaya rempah, menghasilkan cita rasa yang unik dan menggoyah lidah.",
        },{
            id: 8,
            image: "../img/main-course/tengkleng-kambing.jpg",
            ...
            description: "Tengkleng kambing kami adalah hidangan legendaris yang wajib Anda coba. Dimasak dengan santan kental dan bumbu rempah yang khas.",
        },
    ];
