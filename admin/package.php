...
function isColorDark(hex) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    let menuData = [
        {
            id: 1,
            image: "../img/paket/Paket Pa Tani.png",
            name: "Paket Pa Tani",
            price: 38000,
            calories: 560,
            ingredients: [
            ...
            description: "Nikmati kelezatan asli Nusantara dalam Paket Pa Tani! Sate ayam yang empuk dan gurih dipadukan dengan nasi pulen serta es teh segar.",
        },
        {
            id: 2,
            image: "../img/paket/Paket Pa Toni.png",
            name: "Paket Pa Toni",
            price: 38000,
            calories: 550,
            ingredients: [
            ...
            description: "Penuh rasa dan penuh cinta, Paket Pa Toni menghadirkan tongseng ayam berkuah kental dengan bumbu rempah pilihan, ditemani nasi hangat dan es teh segar.",
        },
        {
            id: 3,
            image: "../img/paket/Paket Pa Gesit.png",
            name: "Paket Pa Gesit",
            price: 20000,
            calories: 500,
            ingredients: [
            ...
            description: "Untuk Anda yang aktif dan penuh semangat, Paket Gesit adalah jawabannya! Ayam geprek pedas yang menggoda berpadu dengan nasi hangat dan es teh yang menyegarkan.",
        }
    ];

    const input = document.querySelector('#menuIngredients');
  const tagify = new Tagify(input, {
    whitelist: ["Daging Ayam", "Daging Kambing", "Daging Sapi", "Nasi", "Bumbu Kacang", "Kecap", "Lada Bubuk", "Santan", "Rempah", "Cabai", "Bawang", "Sayuran", "Jeroan", "Air", "Es Batu", "Gula", "Gula Pasir", "Jeruk Peras", "Teh", "Susu Kental Manis", "Sirup", "Mangga", "Alpukat", "Semangka", "Melon", "Nanas", "Jambu Biji", "Daging Ayam", "Bumbu", "Adonan Telur", "Kedelai"],
    dropdown: {
