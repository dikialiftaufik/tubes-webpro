            ...
            <div class="modal-body">
                <form id="addUserForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="radio" id="female" name="gender" value="Female" required> <label for="female">Perempuan</label>
                    </div>
                    <div class="mb-3">
...
<div class="modal fade" id="showUserModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img id="showProfileImage" class="img-fluid rounded-circle mb-3" alt="Profile">
                <p><strong>Nama Lengkap:</strong> <span id="showFullName"></span></p>
                <p><strong>Username:</strong> <span id="showUsername"></span></p>
                <p><strong>Email:</strong> <span id="showEmail"></span></p>
                <p><strong>No. Telepon:</strong> <span id="showPhone"></span></p>
                <p><strong>Tempat, Tanggal Lahir:</strong> <span id="showBirthPlace"></span>, <span id="showBirthDate"></span></p>
                <p><strong>Jenis Kelamin:</strong> <span id="showGender"></span></p>
                <p><strong>Alamat:</strong> <span id="showAddress"></span></p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editUserForm">
                    ...
                    <div class="mb-3">
                        <label for="editBirthPlace" class="form-label">Tempat Lahir</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="editBirthDate" required>
                    </div>
                    <div class="mb-3">
                        <label for="editGender" class="form-label">Jenis Kelamin</label><br>
                        <input type="radio" id="editMale" name="editGender" value="Male" required> <label for="editMale">Laki-Laki</label>
                        <input type="radio" id="editFemale" name="editGender" value="Female" required> <label for="editFemale">Perempuan</label>
                    </div>
                    <div class="mb-3">
...
<script>
  // Update the script section with the following code
$(document).ready(function () {
    // Sample user data
    let userData = [
        {
            id: 1,
            profileImage: '../img/profile/ali.png',
        ...
        {
            id: 2,
            profileImage: '../img/profile/ibou.png',
            username: 'Ibrahima Konate',
            email: 'konate@example.com',
            password: 'YNWA',
        ...
        {
            id: 3,
            profileImage: '../img/profile/virg.png',
        ...
        {
            id: 4,
            profileImage: '../img/profile/taa.png',
            username: 'Tent Alexander-Arnold',
            email: 'taa@example.com',
            password: 'YNWA',
            fullName: 'Treind Alexander-Arnold',
            phone: '081234567890',
            birthDate: '1990-01-01',
            birthPlace: 'New York',
            gender: 'Male',
        ...
        {
            id: 5,
            profileImage: '../img/profile/robbo.png',
        ...
        {
            id: 6,
            profileImage: '../img/profile/macca.png',
            username: 'Alexis McAllister',
            email: 'macca@example.com',
            password: 'YNWA',
            fullName: 'Alexis McAllister',
            phone: '081234567890',
            birthDate: '1990-01-01',
            birthPlace: 'New York',
            gender: 'Male',
        ...
        {
            id: 7,
            profileImage: '../img/profile/szobo.png',
            username: 'Dominic Szoboszlai',
            email: 'szobo@example.com',
            password: 'YNWA',
            fullName: 'Dominic Szoboszlai',
            phone: '081234567890',
            birthDate: '1990-01-01',
            birthPlace: 'New York',
            gender: 'Male',
        ...
        {
            id: 8,
            profileImage: '../img/profile/salah.png',
        ...
        {
            id: 9,
            profileImage: '../img/profile/diaz.png',
            username: 'Luis Diaz',
        ...
        {
            id: 10,
            profileImage: '../img/profile/gakpo.png',
            username: 'Cody Gakpo',
            email: 'gakpo@example.com',
            password: 'YNWA',
            fullName: 'Cody Gakpo',
            phone: '081234567890',
            birthDate: '1990-01-01',
        ...
        {
            id: 11,
            profileImage: '../img/profile/jota.png',
            username: 'Diogo Jota',
    ...
    const usersTable = $('#userTable').DataTable({
        ...
        columns: [
            ...
            },
            {
                data: 'profileImage',
                render: (data) => data ? 
                    `<img src="${data}" class="rounded-circle" style="width: 100px; height: 100px; object-fit: cover;">` : 
                    '<img src="../img/profile/default.jpg" class="rounded-circle" style="width: 50px; height: 50px; object-fit: cover;">'
            },
            { data: 'username' },
            { data: 'email' },
            { data: 'password' },
            {
                ...
                render: function (data) {
                    return `
                        <button class="btn btn-outline-warning btn-sm show-btn" data-id="${data.id}">
                            <i class="bi bi-eye"></i>
                        </button>
                        <button class="btn btn-outline-primary btn-sm edit-btn" data-id="${data.id}">
                            <i class="bi bi-pencil"></i>
                        </button>
                        <button class="btn btn-outline-danger btn-sm delete-btn" data-id="${data.id}">
    ...
    const newUser = {
        id: Date.now(),
        profileImage: $('#profileImage').val() ? URL.createObjectURL($('#profileImage')[0].files[0]) : '',
    ...
    $('#userTable').on('click', '.show-btn', function() {
        const id = $(this).data('id');
        const user = userData.find(u => u.id === id);
        
        if (user) {
            $('#showProfileImage').attr('src', user.profileImage || '../img/profile/default.jpg');
            $('#showFullName').text(user.fullName);
            $('#showUsername').text(user.username);
            $('#showEmail').text(user.email);
            $('#showPhone').text(user.phone);
            $('#showBirthPlace').text(user.birthPlace);
            $('#showBirthDate').text(user.birthDate);
    ...
    $('#userTable').on('click', '.edit-btn', function() {
        ...
        if (user) {
            ...
            $('#editBirthPlace').val(user.birthPlace);
    ...
    $('#updateUser').click(function() {
        ...
        if (index !== -1) {
            ...
            if ($('#editProfileImage')[0].files[0]) {
                userData[index].profileImage = URL.createObjectURL($('#editProfileImage')[0].files[0]);
            }
    ...
    flatpickr('#birthDate, #editBirthDate', {
        dateFormat: 'Y-m-d'
    });
});
